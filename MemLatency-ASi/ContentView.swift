...
class AppViewModel: ObservableObject {
    ...
    @Published var testParametersList: [TestParameter] = [
        ...
        .init(size: "2", iterations: "3000000000"),
        .init(size: "4", iterations: "3000000000"),
        .init(size: "8", iterations: "3000000000"),
        .init(size: "16", iterations: "3000000000"),
        .init(size: "32", iterations: "3000000000"),
        .init(size: "64", iterations: "3000000000"),
        .init(size: "128", iterations: "3000000000"),
        .init(size: "256", iterations: "3000000000"),
        .init(size: "512", iterations: "3000000000"),
        .init(size: "1024", iterations: "100000000"),
        .init(size: "2048", iterations: "100000000"),
        .init(size: "4096", iterations: "100000000"),
        .init(size: "8192", iterations: "10000000"),
        .init(size: "16384", iterations: "10000000"),
        .init(size: "32768", iterations: "10000000"),
        .init(size: "65536", iterations: "10000000"),
        .init(size: "131072", iterations: "1000000"),
        .init(size: "262144", iterations: "33333")
    ]
